<template>
    ...
    >
      <el-form-item :label="t('post.name')" prop="name">
        <el-input
          ...
          :placeholder="t('post.pleaseInput') + t('post.name')"
          clearable
          class="!w-240px"
      ...
      <el-form-item :label="t('post.code')" prop="code">
        <el-input
          ...
          :placeholder="t('post.pleaseInput') + t('post.code')"
          clearable
          class="!w-240px"
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item :label="t('post.status')" prop="status">
        <el-select
          ...
          :placeholder="t('post.pleaseSelect') + t('post.status')"
          clearable
          class="!w-240px"
        >
          <el-option
      ...
      <el-form-item>
        <el-button @click="handleQuery"
          ><Icon icon="ep:search" class="mr-5px" /> {{ t('post.search') }}</el-button
        >
        <el-button @click="resetQuery"
          ><Icon icon="ep:refresh" class="mr-5px" /> {{ t('post.reset') }}</el-button
        >
        <el-button
          type="primary"
          plain
        ...
        >
          <Icon icon="ep:plus" class="mr-5px" /> {{ t('post.create') }}
        </el-button>
        <el-button
          type="success"
          plain
        ...
        >
          <Icon icon="ep:download" class="mr-5px" /> {{ t('post.export') }}
        </el-button>
        <el-button
          type="danger"
          plain
        ...
        >
          <Icon icon="ep:delete" class="mr-5px" /> {{ t('post.batchDelete') }}
        </el-button>
      </el-form-item>
    </el-form>
  </ContentWrap>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :label="t('post.id')" align="center" prop="id" />
      ...
      />
      <el-table-column :label="t('post.actions')" align="center">
        <template #default="scope">
          <el-button
            link
            type="primary"
